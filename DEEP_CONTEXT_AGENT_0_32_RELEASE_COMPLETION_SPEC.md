...
Дата: 2026-09-09; актуализация 2026-09-12. Статус: **реализация/приёмка,
полного production PASS нет**. Факты: [матрица C01–C18](RELEASE_COMPLETION_0_32_ACCEPTANCE.md).
...
Версия пакета пока 0.31.0. Не повторять уже выполненные правки без проверки кода.
