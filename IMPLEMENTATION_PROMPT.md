...
Актуальный обязательный промпт версии 0.3.0 находится в
`ACCEPTANCE_RELIABILITY_PROMPT.md`. Его требования имеют приоритет для
исправления дефектов последнего ручного acceptance-лога от 2026-08-22.
`PRODUCTION_HARDENING_PROMPT.md` сохраняется как история требований версии
0.2.0 и применяется в части, не противоречащей новому промпту.
