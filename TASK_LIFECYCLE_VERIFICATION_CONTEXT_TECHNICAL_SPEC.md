...
и исторические 449 passed сами по себе не означают закрытие production-приёмки.
Код R1–R6 реализован; актуальные доказательства — в RELEASE_COMPLETION_0_32_ACCEPTANCE.md.

Дата: 2026-09-09; актуализация 2026-09-12. Статус и номер принятой версии —
в release matrix. Подготовка ТЗ сама по себе не меняет состояние пользовательских
задач или результат их проверок; чужие задачи в этих тестах не перезапускались.
