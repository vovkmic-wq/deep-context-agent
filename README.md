...
Во вкладке файлов каталоги и текстовые файлы кликабельны. Полный UTF-8 файл
...
перезапуска Web-процесса. Кнопка «Проверить» выполняет отдельный opt-in платный
live-запрос выбранному provider.
...
Версия 0.14.0 предназначена для production-эксплуатации как локальный
